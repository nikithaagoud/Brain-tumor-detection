...
main = tkinter.Tk()
main.title("BRAIN TUMOR DETECTION AND PREDICTION SYSTEM USING DEEP LEARNING") #designing main screen
...
def predict():
    ...
    ftp.login("b.nikithagoud@gmail.com", "nikki@143")
    ftp.prot_p()
    name = imagelist.get()
...
font = ('times', 16, 'bold')
title = Label(main, text='BRAIN TUMOR DETECTION AND PREDICTION SYSTEM USING DEEP LEARNING')
